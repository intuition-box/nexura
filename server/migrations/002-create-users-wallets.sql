-- Migration: create users and wallets tables for Supabase/Postgres
...
-- Note:
-- - The frontend uses Supabase `upsert` on `users` and `wallets`. These unique constraints ensure upserts work as expected.
